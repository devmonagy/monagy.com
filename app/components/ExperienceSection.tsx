...
const EXPERIENCES_DATA: Experience[] = [
  {
    ...
    range: "2025 — Present",
    summary:
      "Design and maintain internal organizational Power Apps and custom solutions using modular components, automated workflows, and secure integrations across Dataverse, SQL Server, and Azure services. Support stakeholders and continuously improve application performance and reliability.",
    skills: [
      "Power Apps",
      "Power Automate",
      "Dataverse",
