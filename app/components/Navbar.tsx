...
export default function Navbar({ theme, toggleTheme }: NavbarProps) {
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-[92vw] max-w-[360px]">
        <nav className="bg-[var(--card-bg)]/85 border border-[var(--border-color)] rounded-full backdrop-blur-xl shadow-[0_12px_40px_rgba(0,0,0,0.5)] px-6 py-3.5">
          <ul className="flex items-center justify-between font-['Plus_Jakarta_Sans',sans-serif] text-[11px] font-bold uppercase tracking-[0.14em]">
            <li>
              <a
                href="#about"
                className="nav-link text-[var(--text)] px-2 pb-2 block"
              >
                About
              </a>
            </li>
